            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-2">
                        <a class="navbar-brand" href="#">
                            <div>
                                <img src="images/book_26px.png" weight="60px" height="40px" class="droite" alt="">
                                <h6>Livres</h6>
                            </div>
                        </a>
                    </div>
                    <div class="col-2">
                        <a class="navbar-brand" href="#">
                            <div>
                                <img src="images/stock_26px.png" weight="60px" height="40px" class="droite" alt="">
                                <h6>Stock</h6>
                            </div>
                        </a>
                    </div>
                    <div class="col-2">   
                        <img src="images/Search_26px.png" class="search-icon">
                    </div>
                    <div class="col-2">
                        <div>
                            <a href="{{route('logout')}}"> <button class="btn btn-light font-weight-bold" type="submit">Déconnexion</button></a>
                        </div>
                    </div>
                </div>
            </div>
